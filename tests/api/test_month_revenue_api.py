...
class TestMonthRevenueGetAPI:
    """Tests for GET /api/v0/month_revenue/<stock_id> endpoint."""

    def test_get_month_revenue_success(self, client, sample_month_revenue):
        """Test successful retrieval of month revenue data."""
        response = client.get(f'/api/v0/month_revenue/{sample_month_revenue.stock_id}')
    ...
    def test_get_month_revenue_with_multiple_records(self, client, sample_month_revenue_list):
        """Test retrieval of multiple month revenue records."""
        stock_id = sample_month_revenue_list[0].stock_id
        response = client.get(f'/api/v0/month_revenue/{stock_id}')

        assert response.status_code == 200
        data = json.loads(response.data)
        assert len(data) >= len(sample_month_revenue_list)

    def test_get_month_revenue_ordered_desc(self, client, sample_basic_info):
        ...
        response = client.get(f'/api/v0/month_revenue/{sample_basic_info.id}')
    ...
    def test_get_month_revenue_empty_result(self, client, sample_basic_info):
    ...
    def test_get_month_revenue_limit_60(self, client, sample_basic_info):
    ...
    def test_get_month_revenue_nonexistent_stock(self, client, app_context):
        """Test retrieval for non-existent stock returns empty list."""
        response = client.get('/api/v0/month_revenue/9999')
...
class TestMonthRevenuePostAPI:
    """Tests for POST /api/v0/month_revenue/<stock_id> endpoint."""

    def test_create_month_revenue_success(self, client, sample_basic_info):
        ...
        response = client.post(
            f'/api/v0/month_revenue/{sample_basic_info.id}',
    ...
    def test_update_existing_month_revenue(self, client, sample_basic_info):
    ...
    def test_update_no_changes_returns_200(self, client, sample_basic_info):
    ...
    def test_create_month_revenue_missing_body(self, client, sample_basic_info):
    ...
    def test_create_month_revenue_invalid_json(self, client, sample_basic_info):
    ...
    def test_create_month_revenue_handles_不適用(self, client, sample_basic_info):
    ...
    def test_create_month_revenue_invalid_stock_returns_400(self, client, app_context):
...
class TestMonthRevenueAPIIntegration:
    ...
    def test_create_then_get(self, client, sample_basic_info):
        ...
        # Get
        get_response = client.get(f'/api/v0/month_revenue/{sample_basic_info.id}')
    ...
    def test_create_multiple_months(self, client, sample_basic_info):
...
class TestMonthRevenueSerializer:
    ...
    def test_serializer_all_fields(self, client, sample_month_revenue):
    ...
    def test_serializer_date_format(self, client, sample_month_revenue):
