...
class TestIncomeSheetGetAPI:
    ...
    def test_get_income_sheet_default(self, authenticated_client, sample_income_sheet):
        """Test GET without mode returns latest income sheet."""
        response = authenticated_client.get(f'/api/v0/income_sheet/{sample_income_sheet.stock_id}')
    ...
    def test_get_income_sheet_single_mode(self, authenticated_client, temp_income_sheet):
    ...
    def test_get_income_sheet_single_missing_params(self, authenticated_client, sample_basic_info, params, description):
        """Test GET with mode=single but missing year/season returns 400."""
        response = authenticated_client.get(f'/api/v0/income_sheet/{sample_basic_info.id}{params}')
        assert response.status_code == 400, f"Should fail for {description}"

    def test_get_income_sheet_invalid_season(self, authenticated_client, sample_basic_info):
    ...
    def test_get_income_sheet_multiple_mode(self, authenticated_client, temp_income_sheets_4_seasons, sample_basic_info):
    ...
    def test_get_income_sheet_multiple_default_year(self, authenticated_client, temp_income_sheets_4_seasons, sample_basic_info):
    ...
    def test_get_income_sheet_invalid_mode(self, authenticated_client, sample_basic_info):
    ...
    def test_get_income_sheet_nonexistent_stock(self, authenticated_client):
        """Test GET for non-existent stock returns 404."""
        response = authenticated_client.get('/api/v0/income_sheet/9999')
        assert response.status_code == 404

    def test_get_income_sheet_ordering(self, authenticated_client, temp_income_sheets_multi_year, sample_basic_info):
...
class TestIncomeSheetPostAPI:
    ...
    def test_create_income_sheet_success(self, authenticated_client, sample_basic_info):
    ...
    def test_update_income_sheet_success(self, authenticated_client, temp_income_sheet):
    ...
    def test_update_income_sheet_no_change(self, authenticated_client, temp_income_sheet):
    ...
    def test_create_income_sheet_invalid_request(self, authenticated_client, sample_basic_info, data, content_type, description):
    ...
    def test_create_income_sheet_invalid_stock_returns_400(self, authenticated_client):
...
class TestCheckFourSeasonEPS:
    ...
    def test_four_season_eps_calculated(self, authenticated_client, temp_income_sheets_with_eps, sample_basic_info):
    ...
    def test_four_season_eps_creates_daily_info(self, authenticated_client, sample_basic_info):
...
class TestIncomeSheetAPIIntegration:
    ...
    def test_create_then_get(self, authenticated_client, sample_basic_info, cleanup_integration_income_sheet):
    ...
    def test_create_multiple_seasons(self, authenticated_client, sample_basic_info, cleanup_integration_income_sheet):
...
class TestIncomeSheetSerializer:
    ...
    def test_serializer_includes_all_fields(self, authenticated_client, sample_income_sheet):
    ...
    def test_serializer_dates_format(self, authenticated_client, sample_income_sheet):
