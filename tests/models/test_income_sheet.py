...
class TestIncomeSheetDatabaseOperations:
    ...
    def test_create_income_sheet(self, sample_basic_info):
    ...
    def test_read_income_sheet(self, sample_income_sheet):
    ...
    def test_update_income_sheet(self, sample_basic_info):
    ...
    def test_delete_income_sheet(self, sample_basic_info):
...
class TestIncomeSheetConstraints:
    ...
    def test_unique_constraint_stock_year_season(self, sample_basic_info):
    ...
    def test_valid_season_enum_values(self, sample_basic_info):
...
class TestIncomeSheetQueries:
    ...
    def test_query_by_stock_id(self, sample_income_sheet_list):
    ...
    def test_query_by_year(self, sample_income_sheet_list):
    ...
    def test_query_ordered_by_year_season_desc(self, sample_basic_info):
    ...
    def test_query_latest_income_sheet(self, sample_basic_info):
...
class TestIncomeSheetEdgeCases:
    ...
    def test_negative_values_for_losses(self, sample_basic_info):
    ...
    def test_decimal_precision(self, sample_basic_info):
    ...
    def test_profit_margin_fields(self):
