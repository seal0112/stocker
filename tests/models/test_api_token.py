...
class TestApiTokenModel:
    ...
    def test_create_token_success(self, test_app, regular_user):
        ...
        assert api_token.user_id == regular_user.id
        assert api_token.is_active is True
        assert plain_token.startswith('stk_')

    def test_create_token_with_scopes(self, test_app, regular_user):
    ...
    def test_create_token_with_expiration(self, test_app, regular_user):
    ...
    def test_create_token_max_limit(self, test_app, regular_user):
        """Creating more than MAX_TOKENS_PER_USER should raise error."""
        # Create max tokens
        for i in range(ApiToken.MAX_TOKENS_PER_USER):
            ApiToken.create_token(user_id=regular_user.id, name=f'Token {i}')

        # Try to create one more
        with pytest.raises(ValueError, match='Maximum .* tokens allowed'):
            ApiToken.create_token(user_id=regular_user.id, name='Extra Token')

    def test_verify_token_success(self, test_app, regular_user):
    ...
    def test_verify_token_expired(self, test_app, regular_user):
    ...
    def test_verify_token_updates_last_used(self, test_app, regular_user):
    ...
    def test_revoke_token(self, test_app, regular_user):
    ...
    def test_regenerate_token(self, test_app, regular_user):
    ...
    def test_is_expired_property(self, test_app, regular_user):
    ...
    def test_to_dict(self, test_app, regular_user):
    ...
    def test_to_dict_with_token(self, test_app, regular_user):
